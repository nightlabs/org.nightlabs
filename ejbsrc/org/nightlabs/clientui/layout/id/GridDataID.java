 ...
 * {@link org.nightlabs.clientui.layout.GridData}.
...
implements Serializable, org.nightlabs.jdo.ObjectID
{
	 ...
	 *
	 * See {@link org.nightlabs.clientui.layout.GridData#gridDataID}.
	 */
	 ...
	 */
	public GridDataID(String keyStr)
	...
	public String toString() {
		...
		try {
		 sb.append("gridDataID=");
		 sb.append(encodeFieldValue(gridDataID));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GridDataID))
			return false;

		GridDataID other = (GridDataID)obj;

		return
					this.gridDataID == other.gridDataID
			;
	}
	 ...
	 *
	 * @param gridDataID The primary key field gridDataID. See {@link org.nightlabs.clientui.layout.GridData#gridDataID}.
	 * @return a newly created instance of <code>GridDataID</code>
	 *		with the primary-key fields set to the given parameters.
	 */
	public static GridDataID create(
				long gridDataID
		)
	{
