 ...
 * {@link org.nightlabs.clientui.layout.GridLayout}.
 * <p>This class was auto-generated using XDoclet.
 */
public class GridLayoutID
implements Serializable, org.nightlabs.jdo.ObjectID
{
	 ...
	 *
	 * See {@link org.nightlabs.clientui.layout.GridLayout#gridLayoutID}.
	 */
	 ...
	 */
	public GridLayoutID(String keyStr)
	...
	public String toString() {
		...
		try {
		 sb.append("gridLayoutID=");
		 sb.append(encodeFieldValue(gridLayoutID));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GridLayoutID))
			return false;

		GridLayoutID other = (GridLayoutID)obj;

		return
					this.gridLayoutID == other.gridLayoutID
			;
	}
	...
	{
		return
					primitiveHashCode(gridLayoutID)
			;
	}
	 ...
	 *
	 * @param gridLayoutID The primary key field gridLayoutID. See {@link org.nightlabs.clientui.layout.GridLayout#gridLayoutID}.
	 * @return a newly created instance of <code>GridLayoutID</code>
	 *		with the primary-key fields set to the given parameters.
	 */
	public static GridLayoutID create(
				long gridLayoutID
		)
	{
