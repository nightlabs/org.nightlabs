 ...
 *   {@link com.nightlabs.rcp.wizard.DynamicWizardPopulator#addDynamicWizardPages(DynamicPathWizard)}.
...
//			throw new NullPointerException("createWizardEntryPage() must not return null!");
	...
	/**
	 * @see com.nightlabs.rcp.wizard.IDynamicPathWizard#getDynamicWizardPageCount()
	 */
   ...
   * @throws IllegalStateException if the value of index is illegal
   * @see com.nightlabs.rcp.wizard.IDynamicPathWizard#addDynamicWizardPage(int, com.nightlabs.rcp.wizard.IDynamicPathWizardPage)
   */
   ...
   * Overridden method.
   * @param page The page to add
   * @see com.nightlabs.rcp.wizard.IDynamicPathWizard#addDynamicWizardPage(com.nightlabs.rcp.wizard.IDynamicPathWizardPage)
   */
   ...
   * @see com.nightlabs.rcp.wizard.IDynamicPathWizard#getDynamicWizardPageIndex(com.nightlabs.rcp.wizard.IDynamicPathWizardPage)
   */
	...
	/**
	 * @see com.nightlabs.rcp.wizard.IDynamicPathWizard#getDynamicWizardPage(int)
	 */
	...
	/**
	 * @see com.nightlabs.rcp.wizard.IDynamicPathWizard#removeDynamicWizardPage(int)
	 */
	...
	/**
	 * @see com.nightlabs.rcp.wizard.IDynamicPathWizard#removeDynamicWizardPage(com.nightlabs.rcp.wizard.IDynamicPathWizardPage)
	 */
