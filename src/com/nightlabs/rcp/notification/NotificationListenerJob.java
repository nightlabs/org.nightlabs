 ...
 * {@link com.nightlabs.rcp.notification.NotificationAdapterJob}.
 *
...
public interface NotificationListenerJob extends NotificationListener
{
	 ...
	 * {@link NotificationListener#notify(com.nightlabs.notification.NotificationEvent)} must be called by
	 * your <tt>Job</tt> or will not be called at all!
	 *
	 * @param event The same notification event that will be passed to {@link NotificationListener#notify(com.nightlabs.notification.NotificationEvent)}.
	 *
	 ...
	 * {@link NotificationListener#notify(com.nightlabs.notification.NotificationEvent)}.
	 *
