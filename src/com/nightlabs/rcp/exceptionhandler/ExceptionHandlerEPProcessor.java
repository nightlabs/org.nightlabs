 ...
 * Finds elements and makes registrations in {@link com.nightlabs.rcp.exceptionhandler.ExceptionHandlerRegistry}.
 * 
 * @author Alexander Bieber <alex[AT]nightlabs[DOT]de>
 */
public class ExceptionHandlerEPProcessor extends AbstractEPProcessor{
	
	public static final String ExtensionPointID = "com.nightlabs.base.exceptionhandler";
	/**
