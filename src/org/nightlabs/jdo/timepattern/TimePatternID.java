...
/**
 * The JDO object id class for {@link org.nightlabs.jdo.timepattern.TimePatternJDOImpl}.
...
implements ObjectID
{
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -515632574L;
	...
	/**
	 * Primary key field timePatternID.
	 * Declared as primary key field in {@link org.nightlabs.jdo.timepattern.TimePatternJDOImpl}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String timePatternID;

	/**
	 * Create a new empty instance of TimePatternID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public TimePatternID()
	{
	}

	/**
	 * Create a new instance of TimePatternID.
	 ...
	 * <code>TimePatternID newTimePatternID = new TimePatternID(oldTimePatternID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public TimePatternID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends TimePatternID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			sb.append("timePatternID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(timePatternID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		TimePatternID other = (TimePatternID) obj;
		if(timePatternID == null) {
			if(other.timePatternID != null)
				return false;
		} else if(!timePatternID.equals(other.timePatternID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + ((timePatternID == null) ? 0 : timePatternID.hashCode());
		return result;
	}

	/**
	 * Create a new object id instance.
	 * @param timePatternID The primary key field timePatternID.
	 * @return a newly created instance of <code>TimePatternID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static TimePatternID create(String timePatternID)
	{
		TimePatternID n = new TimePatternID();
		n.timePatternID = timePatternID;
		return n;
	}
}
