...
package org.nightlabs.jdo.timepattern.id;
...
/**
 * The JDO object id class for {@link org.nightlabs.jdo.timepattern.TimePatternSetJDOImpl}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class TimePatternSetID
implements ObjectID
{
	/**
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -1601661349L;
	...
	/**
	 * Primary key field timePatternSetID.
	 * Declared as primary key field in {@link org.nightlabs.jdo.timepattern.TimePatternSetJDOImpl}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public java.lang.String timePatternSetID;

	/**
	 * Create a new empty instance of TimePatternSetID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public TimePatternSetID()
	{
	}

	/**
	 * Create a new instance of TimePatternSetID.
	 ...
	 * <code>TimePatternSetID newTimePatternSetID = new TimePatternSetID(oldTimePatternSetID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public TimePatternSetID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends TimePatternSetID> clazz = this.getClass();
	...
	public String toString()
	{
		...
		try {
			sb.append("timePatternSetID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(String.valueOf(timePatternSetID), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		TimePatternSetID other = (TimePatternSetID) obj;
		if(timePatternSetID == null) {
			if(other.timePatternSetID != null)
				return false;
		} else if(!timePatternSetID.equals(other.timePatternSetID))
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + ((timePatternSetID == null) ? 0 : timePatternSetID.hashCode());
		return result;
	}

	/**
	 * Create a new object id instance.
	 * @param timePatternSetID The primary key field timePatternSetID.
	 * @return a newly created instance of <code>TimePatternSetID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static TimePatternSetID create(String timePatternSetID)
	{
		TimePatternSetID n = new TimePatternSetID();
		n.timePatternSetID = timePatternSetID;
		return n;
	}
}
