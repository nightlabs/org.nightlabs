 ...
 *   {@link org.nightlabs.rcp.wizard.DynamicWizardPopulator#addDynamicWizardPages(DynamicPathWizard)}.
...
//			throw new NullPointerException("createWizardEntryPage() must not return null!");
	...
	/**
	 * @see org.nightlabs.rcp.wizard.IDynamicPathWizard#getDynamicWizardPageCount()
	 */
   ...
   * @throws IllegalStateException if the value of index is illegal
   * @see org.nightlabs.rcp.wizard.IDynamicPathWizard#addDynamicWizardPage(int, org.nightlabs.rcp.wizard.IDynamicPathWizardPage)
   */
   ...
   * Overridden method.
   * @param page The page to add
   * @see org.nightlabs.rcp.wizard.IDynamicPathWizard#addDynamicWizardPage(org.nightlabs.rcp.wizard.IDynamicPathWizardPage)
   */
   ...
   * @see org.nightlabs.rcp.wizard.IDynamicPathWizard#getDynamicWizardPageIndex(org.nightlabs.rcp.wizard.IDynamicPathWizardPage)
   */
	...
	/**
	 * @see org.nightlabs.rcp.wizard.IDynamicPathWizard#getDynamicWizardPage(int)
	 */
	...
	/**
	 * @see org.nightlabs.rcp.wizard.IDynamicPathWizard#removeDynamicWizardPage(int)
	 */
	...
	/**
	 * @see org.nightlabs.rcp.wizard.IDynamicPathWizard#removeDynamicWizardPage(org.nightlabs.rcp.wizard.IDynamicPathWizardPage)
	 */
