 ...
 */
@Deprecated
public class Base36CoderUpperCase
extends Base36Coder
{
	private static Base36CoderUpperCase _sharedInstance = null;

	/**
	 * You can either use your own instance or a shared instance of this class.
	 * It makes sense, to use the shared instance.
	 */
	public static Base36CoderUpperCase sharedInstance()
	{
		if (_sharedInstance == null)
			_sharedInstance = new Base36CoderUpperCase();

		return _sharedInstance;
	}

	public Base36CoderUpperCase()
	{
		super(true);
	}
