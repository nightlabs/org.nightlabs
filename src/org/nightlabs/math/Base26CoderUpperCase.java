 ...
 */
@Deprecated
public class Base26CoderUpperCase
extends Base26Coder
{
	private static Base26CoderUpperCase sharedInstance_With09 = null;
	private static Base26CoderUpperCase sharedInstance_No09 = null;

	/**
	 * You can either use your own instance or a shared instance of this class.
	 * It makes sense, to use the shared instance.
	 */
	public static Base26CoderUpperCase sharedInstance(boolean include09)
	{
		if (include09) {
			if (sharedInstance_With09 == null)
				sharedInstance_With09 = new Base26CoderUpperCase(include09);
	
			return sharedInstance_With09;
		}
		else {
			if (sharedInstance_No09 == null)
				sharedInstance_No09 = new Base26CoderUpperCase(include09);
	 ...
	 *		the range is 'A'..'Z'
	 */
	public Base26CoderUpperCase(boolean include09)
	{
		super(true, include09);
	}
