...
import org.nightlabs.editor2d.command.shape.ShapeIntersectCommand;
...
extends AbstractBooleanOperationAction 
{
	...
	{
		setId(ID);
		setText(Messages.getString("org.nightlabs.editor2d.actions.shape.ShapeIntersectAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.editor2d.actions.shape.ShapeIntersectAction.tooltip"));		 //$NON-NLS-1$
	}
}
