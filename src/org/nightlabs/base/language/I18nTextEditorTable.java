...
public class I18nTextEditorTable extends XComposite{
	...
	private I18nTextEditorTableItemList i18nTableItemList;
...
//		int columnWidth = getParent().getBounds().width / columnNames.length;
	 ...
	 */
	public I18nTextEditorTableItemList getI18nTableItemList() {
	...
	public void setI18nTableItemList(I18nTextEditorTableItemList tableItemList) {
