 ...
 *
 */
public abstract class AbstractFileDialogComposite<FileDialogType extends Dialog> extends XComposite {

	/**
	 * @param parent
	 * @param style
	 */
	public AbstractFileDialogComposite(Composite parent, int style, String caption) {
		super(parent, style);
	 ...
	 * @param style
	 */
	public AbstractFileDialogComposite(Composite parent, int style, LayoutMode layoutMode, 
	...
	private void createContents(String caption) {
		...
		fileTextControl.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e)
			{
				...
				AbstractFileDialogComposite.this.modifyText(e);
			}
		});
		...
		browseButton.addSelectionListener(new SelectionAdapter() {
			...
			{
				FileDialogType fileDialog = createFileDialog(RCPUtil.getActiveWorkbenchShell());
				setUpFileDialog(fileDialog);
				String selectedFile = openDialog(fileDialog);
	...
	protected abstract FileDialogType createFileDialog(Shell parentShell);
	
	protected abstract String openDialog(FileDialogType dialog);
	 ...
	 */
	protected abstract void setUpFileDialog(FileDialogType fileDialog);
