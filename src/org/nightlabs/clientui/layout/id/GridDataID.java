...
/**
 * The JDO object id class for {@link org.nightlabs.clientui.layout.GridData}.
 * <p>This class was auto-generated.</p>
 */
@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
public class GridDataID
implements Serializable
{
	 ...
	 */ 
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	private static final long serialVersionUID = -2075966150L;
	...
	/**
	 * Primary key field gridDataID.
	 * Declared as primary key field in {@link org.nightlabs.clientui.layout.GridData}.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public long gridDataID;
	
	/**
	 * Create a new empty instance of GridDataID.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public GridDataID()
	{
	...
	/**
	 * Create a new instance of GridDataID.
	 ...
	 * <code>GridDataID newGridDataID = new GridDataID(oldGridDataID.toString());</code>
	 * </p>
	 ...
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public GridDataID(final String keyStr)
	throws ParseException, SecurityException,
			NoSuchFieldException, IllegalArgumentException,
			IllegalAccessException, NoSuchMethodException,
			InstantiationException, InvocationTargetException
	{
		Class<? extends GridDataID> clazz = this.getClass();
	...
	public String toString() 
	{
		...
		try {
			sb.append("gridDataID="); //$NON-NLS-1$
			sb.append(URLEncoder.encode(Long.toString(gridDataID, RADIX), ENCODING));
		} catch (UnsupportedEncodingException e) {
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		GridDataID other = (GridDataID) obj;
		if(gridDataID != other.gridDataID)
			return false;
		return true;
	}
	...
	public int hashCode()
	{
		final int prime = 31;
		int result = 1;
		result = prime * result + (int) (gridDataID ^ (gridDataID >>> 32));
		return result;
	}

	/**
	 * Create a new object id instance.
	 * @param gridDataID The primary key field gridDataID.
	 * @return a newly created instance of <code>GridDataID</code>
	 *     with the primary-key fields set to the given parameters.
	 */
	@Generated("org.nightlabs.eclipse.sdk.jdo.ObjectIdGenerator")
	public static GridDataID create(long gridDataID)
	{
		GridDataID n = new GridDataID();
		n.gridDataID = gridDataID;
		return n;
	}
}
