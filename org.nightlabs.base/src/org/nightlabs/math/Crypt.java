 ...
 * </pre>
 * 
 * The original version of this class was in package <code>org.vps.crypt</code>.
 * 
...
//	private static int direction = 0;
	...
	/**
	 * A string with characters from which a random salt can be chosen.
	 * @author Marc Klinger - marc[at]nightlabs[dot]de
	 */
	private static final String seedChars = "./0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
	...
	private static byte[] getRandomSalt()
	{
		...
		Random r = new Random();
		salt[0] = (byte)seedChars.charAt(r.nextInt(seedChars.length()));
		salt[1] = (byte)seedChars.charAt(r.nextInt(seedChars.length()));
		return salt;
	}
	
	/**
	 * crypt function which choses a random salt for
	 * first-time encryption.
	 * 
	 * @param originalString	    String, maximum 8 bytes, string to encrypt
	 * @author Marc Klinger - marc[at]nightlabs[dot]de
	 */
	public static String crypt(String originalString)
	{
		return crypt(getRandomSalt(), originalString);
	}
	...
	{
		return crypt(getRandomSalt(), original);
	}
